 ...
 */
public class X_AddTakeAway_S3 extends XPRZ_Generic_SelectCorrectObject
{
    ...
    public void demo3a() throws Exception
    {
        ...
        XPRZ_Generic.pointer_moveToRelativePointOnScreen(0.5f, 0.7f, 0.0f, 0.4f, true, this);
        waitAudio();
        //
        ...
        unlockScreen();
        //
        XPRZ_Generic.pointer_moveToObjectByName("loop_1", -20, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        ...
        unlockScreen();
        //
        XPRZ_Generic.pointer_moveToObjectByName("loop_2", -10, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // Now there are three cakes.
        XPRZ_Generic.pointer_moveToObjectByName("loop_big", -15, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        ...
        XPRZ_Generic.pointer_moveToObject(group1.objectDict.get("obj_2"), -20, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // Two.
        XPRZ_Generic.pointer_moveToObject(group1.objectDict.get("obj_1"), -15, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // Three.
        XPRZ_Generic.pointer_moveToObject(group2, -10, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        OBControl number = numbers.get("number_3");
        action_playNextDemoSentence(false); // Touch three.
        XPRZ_Generic.pointer_moveToObject(number, -20, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        XPRZ_Generic.pointer_moveToObject(number, -20, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_MIDDLE), true, this);
        ...
        XPRZ_Generic.pointer_moveToObject(equation.get(2), 0, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // This means ADD
        XPRZ_Generic.pointer_moveToObject(equation.get(1), -5, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // This means GIVES or EQUALS
        XPRZ_Generic.pointer_moveToObject(equation.get(3), -5, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        for (int i = 0; i < 5; i++)
        {
            XPRZ_Generic.pointer_moveToObject(equation.get(i), -20+i*5, (i == 0 ? 0.6f : 0.3f), EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
            action_playNextDemoSentence(false);
            action_resizeLabel(equation.get(i), true);
            waitAudio();
            action_resizeLabel(equation.get(i), false);
