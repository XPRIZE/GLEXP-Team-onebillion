 ...
 */
public class X_Count100_S2j extends XPRZ_SectionController
{
    ...
    public void prepare()
    {
        ...
        X_Count100_Additions.drawGrid(5,objectDict.get("workrect"),OBUtils.colorFromRGBString(eventAttributes.get("linecolour")),numColour,false,this);
    ...
    public void setUpDragNum(String event) throws Exception
    {
        ...
        for(String index : OBUtils.randomlySortedArray(indexList))
        {
            ...
            gr.setProperty("targetpos", XPRZ_Generic.copyPoint(gr.position()));
            ...
            gr.setProperty("startpos",XPRZ_Generic.copyPoint(gr.position()));
    ...
    public void checkTargetClick() throws Exception
    {
        ...
        X_Count100_Additions.playNumberAudio(currentIndex,false,this);
        if(currentIndex == 1)
        {
    ...
    public void completeDragNum(OBControl cont)
    {
        ...
        for(String num : nums)
        {
            numAnims.add(OBAnim.colourAnim("colour",X_Count100_S2.getEventColourForIndex((String)cover.attributes().get("cindex"),this),objectDict.get(String.format("num_%s",num))));
    ...
    public void demoCount(List<String> arr) throws Exception
    {
        ...
        for(String num : arr)
        {
            ...
            X_Count100_Additions.playNumberAudio(Integer.valueOf(num),true,this);
            waitForSecs(0.3f);
            movetime=0.2f;
        }
    }
