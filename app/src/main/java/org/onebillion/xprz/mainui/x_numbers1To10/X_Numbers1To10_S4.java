 ...
 */
public class X_Numbers1To10_S4 extends XPRZ_Generic_SelectCorrectObject
{
    ...
    public void action_answerIsCorrect (OBControl target) throws Exception
    {
        ...
        else
        {
            ...
            for (OBControl control : filterControls("obj_.*"))
            {
                ...
                {
                    animations.add(OBAnim.moveAnim(XPRZ_Generic.copyPoint(referenceObject.position()), control));
                }
            }
