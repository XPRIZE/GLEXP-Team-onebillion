 ...
 */
public class X_MoreAddSubtract_S6 extends XPRZ_SectionController
{
    ...
    public void setSceneXX(String scene)
    {
        ...
        X_Numberlines_Additions.loadEquation(equation1,"equation_1",objectDict.get("eqbox1"),eventColour.get("equation"),false,0,1,this);
        ...
        X_Numberlines_Additions.loadEquation(equation2,"equation_2",objectDict.get("eqbox2"),eventColour.get("equation"),false,0,1,this);
    ...
    public void showPhaseEquation() throws Exception
    {
        ...
        if(currentPhase == 1 || currentPhase == 3)
        {
            equation.show();
            for(int i=2; i<6; i++)
                X_Numberlines_Additions.getLabelForEquation(i,equation).hide();
        }
        else
        {
            for(int i=2; i<5; i++)
                X_Numberlines_Additions.getLabelForEquation(i,equation).show();

            OBControl cover = objectDict.get("cover");
            cover.setPosition(X_Numberlines_Additions.getLabelForEquation(5,equation).getWorldPosition());
            cover.show();
        }
        unlockScreen();
    ...
    public void demo6a3() throws Exception
    {
        ...
        waitForSecs(0.3f);
        loadPointer(POINTER_LEFT);
        OBLabel label = X_Numberlines_Additions.getLabelForEquation(1,(OBGroup)objectDict.get("equation_2"));
