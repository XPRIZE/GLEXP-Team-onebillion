 ...
 */
public class X_MakeSylWord extends XPRZ_SectionController
{
    ...
    public void setWordScene(int index)
    {
        ...
        for(int i=0; i<textParts.size(); i++)
        {
            ...
            if(rangeStart != -1)
            {
                ...
                partLabel.setProperty("word_loc", XPRZ_Generic.copyPoint(partLabel.position()));
        ...
        for (int i = 0;i < parts.size();i++)
        {
            ...
            label.setProperty("drop_loc", XPRZ_Generic.copyPoint(label.position()));
        }
