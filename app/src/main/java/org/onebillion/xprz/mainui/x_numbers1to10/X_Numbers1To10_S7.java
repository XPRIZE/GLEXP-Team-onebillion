 ...
 */
public class X_Numbers1To10_S7 extends XPRZ_Generic_SelectCorrectObject
{
    ...
    public void demo7a () throws Exception
    {
        ...
        XPRZ_Generic.pointer_moveToObject(number, -10, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        action_resizeNumber(number, true, false);
        waitAudio();
        waitForSecs(0.3);
        //
