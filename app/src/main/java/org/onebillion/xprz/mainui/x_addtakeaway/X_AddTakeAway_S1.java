 ...
 */
public class X_AddTakeAway_S1 extends XPRZ_Generic_SelectCorrectObject
{
    ...
    public void demo1a() throws Exception
    {
        ...
        XPRZ_Generic.pointer_moveToObjectByName("domino", -15, 1.2f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        ...
        for (OBControl dot : dots)
        {
            ...
            movePointerToPoint(absolutePosition, -15-XPRZ_Generic.randomInt(0,5), 0.3f + (dot.equals(dots.get(0)) ? 0.3f : 0.0f), true);
        ...
        XPRZ_Generic.pointer_moveToObject(number, -15, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        XPRZ_Generic.pointer_moveToObject(number, -15, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_MIDDLE), true, this);
        ...
        XPRZ_Generic.pointer_moveToObject(bigNumber, -5, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        thePointer.hide();
    ...
    public void demo1i() throws Exception
    {
        ...
        XPRZ_Generic.pointer_moveToObjectByName("domino2", -15, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
