 ...
 */
public class X_CountMore_S1 extends XPRZ_SectionController
{
    ...
    public void loadChildrenPlaces()
    {
        ...
        for(OBControl control : filterControls("place_child_.*"))
        {
            ...
            PointF loc = XPRZ_Generic.copyPoint(shield.position());
    ...
    public static void hiliteClothes(OBGroup child,boolean on, XPRZ_SectionController controller)
    {
