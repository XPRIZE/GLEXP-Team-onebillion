 ...
 */
public class X_Alpha extends XPRZ_Generic_WordsEvent
{
    float yinc;
    int boxesPerRow;
    ...
    public void layOutRope ()
    {
        ...
        int startBox = 0;
        Path p = new Path();
        PointF position = XPRZ_Generic.copyPoint(boxes.get(0).position());
        ...
        while (!finished)
        {
            ...
            position = XPRZ_Generic.copyPoint(boxes.get(lastBox).position());
