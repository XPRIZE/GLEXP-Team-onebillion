...
public class X_AddTakeAway_S7 extends XPRZ_Generic_Event
{
    ...
    public void action_prepareScene (String scene, Boolean redraw)
    {
        ...
        {
            control.setProperty("originalPosition", XPRZ_Generic.copyPoint(control.getWorldPosition()));
        }
    }
    ...
    public void action_linkSnakesAndLadders ()
    {
        ...
        for (String link_id : links)
        {
            ...
            //
            PointF firstCell_delta = OB_Maths.DiffPoints(first_cell.getWorldPosition(), OB_Maths.AddPoints(path.topLeft(), XPRZ_Generic.firstPoint(path, this)));
            PointF newFirstPoint = OB_Maths.AddPoints(XPRZ_Generic.firstPoint(path, this), firstCell_delta);
            XPRZ_Generic.setFirstPoint(path, newFirstPoint, this);
            //
            PointF lastCell_delta = OB_Maths.DiffPoints(last_cell.getWorldPosition(), OB_Maths.AddPoints(path.topLeft(), XPRZ_Generic.lastPoint(path, this)));
            PointF newLastPoint = OB_Maths.AddPoints(XPRZ_Generic.lastPoint(path, this), lastCell_delta);
            XPRZ_Generic.setLastPoint(path, newLastPoint, this);
            //
    ...
    public void action_shakeTumbler (int firstDice, int lastDice) throws Exception
    {
        ...
        //
        PointF originalPosition_dice_1 = XPRZ_Generic.copyPoint((PointF) dice_1.propertyValue("originalPosition"));
        PointF originalPosition_dice_2 = XPRZ_Generic.copyPoint((PointF) dice_2.propertyValue("originalPosition"));
        //
        ...
        rotateAnim1 = OBAnim.rotationAnim((float) Math.toRadians(-XPRZ_Generic.randomInt(0, 10)), dice_1);
        rotateAnim2 = OBAnim.rotationAnim((float) Math.toRadians(-XPRZ_Generic.randomInt(0, 10)), dice_2);
    ...
    public Boolean isPlayerGoingToGetSnake ()
    {
        ...
        int percentage = XPRZ_Generic.randomInt(0, 100);
    ...
    public int randomPlay ()
    {
        ...
        if (positions.size() > 0)
        {
            int index = XPRZ_Generic.randomInt(0, positions.size() - 1);
        ...
        {
            return XPRZ_Generic.randomInt(2, Math.min(lastPosition - currentPosition, maxDiceValue));
        }
    }
    ...
    public void demo7a () throws Exception
    {
        ...
        XPRZ_Generic.pointer_moveToObjectByName("counter", -10, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // You must move it to here.
        XPRZ_Generic.pointer_moveToObjectByName("cell_23", -5, 1.2f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // So touch the cup to shake it
        XPRZ_Generic.pointer_moveToObjectByName("tumbler", -20, 1.2f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_MIDDLE), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        XPRZ_Generic.pointer_simulateClick(this);
        action_shakeTumbler(2, 1);
        //
        action_playNextDemoSentence(false); // Count the spots on the dice.
        XPRZ_Generic.pointer_moveToObjectByName("dice_2", -25, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM, XPRZ_Generic.Anchor.ANCHOR_LEFT), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        ...
        XPRZ_Generic.pointer_moveToObject(spot, -25, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        action_playNextDemoSentence(true); // One.
        //
        spot = layer.objectDict.get("dot_2_2");
        XPRZ_Generic.pointer_moveToObject(spot, -23, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        ...
        XPRZ_Generic.pointer_moveToObject(spot, -21, 0.3f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        action_playNextDemoSentence(true); // Three.
        waitForSecs(0.3);
        //
        action_playNextDemoSentence(false); // Move the counter three places
        XPRZ_Generic.pointer_moveToObjectByName("counter", -10, 0.6f, EnumSet.of(XPRZ_Generic.Anchor.ANCHOR_MIDDLE), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
        OBControl counter = objectDict.get("counter");
        ...
        XPRZ_Generic.pointer_moveToPointWithObject(counter, cell_1.position(), -20, 0.3f, true, this);
        ...
        XPRZ_Generic.pointer_moveToPointWithObject(counter, cell_2.position(), -15, 0.3f, true, this);
        playSfxAudio("counter_move", false);
        lockScreen();
        cell_1.lowlight();
        cell_2.highlight();
        ...
        XPRZ_Generic.pointer_moveToPointWithObject(counter, cell_3.position(), -10, 0.3f, true, this);
        playSfxAudio("counter_move", false);
        lockScreen();
        cell_2.lowlight();
        cell_3.highlight();
    ...
    public void checkDragAtPoint (PointF pt)
    {
        ...
        {
            System.out.println("X_AddTakeAway_S6.checkDragAtPoint.exception caught: " + e.toString());
            e.printStackTrace();
        }
    }
    ...
    setStatus(STATUS_CHECKING);
        ...
        {
            System.out.println("X_AddTakeAway_S7.checkDropAtPoint.exception caught: " + e.toString());
            e.printStackTrace();
        }
        //
        setStatus(STATUS_AWAITING_CLICK);
    ...
    public void checkTumbler (OBControl targ)
    {
        ...
        {
            System.out.println("X_AddTakeAway_S7.checkTumbler.exception caught: " + e.toString());
            e.printStackTrace();
        }
        //
        setStatus(STATUS_AWAITING_CLICK);
