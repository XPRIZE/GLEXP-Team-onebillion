 ...
 */
public class X_Numberlines_Additions
{

    public static void drawNumberLine(OBControl rect, int size, int start, int mainColour, int divColour, int numColour, XPRZ_SectionController controller)
    {
    ...
    public static void animateCurve(int num,boolean clockwise ,float duration, boolean audio, boolean label, XPRZ_SectionController controller) throws Exception
    {
    ...
    public static void shortenDiv(int num, XPRZ_SectionController controller)
    {
        OBPath divline = (OBPath)controller.objectDict.get(String.format("divline_%d", num));
        divline.setStrokeStart(0.15f);
    }

    public static void resetNumberLine(boolean clearNum,boolean hideNum, XPRZ_SectionController controller)
    {
    ...
    public static void drawCurveLine(int num,boolean clockwise, boolean label, XPRZ_SectionController controller) throws Exception
    {
    ...
    public static void animateNumberLineShow(float duration, XPRZ_SectionController controller) throws Exception
    {
        OBPath mainLine = (OBPath)controller.objectDict.get("mainline");
    ...
    public static void setUpBasket(XPRZ_SectionController controller)
    {
    ...
    public static void moveBasketParts(XPRZ_SectionController controller)
    {
    ...
    public static void loadEquation(String string,String name, OBControl boxControl, int colour, boolean groupBox, XPRZ_SectionController controller)
    {
        loadEquation(string,name,boxControl,colour,groupBox,1,1,controller);
    }


    public static void loadEquation(String string,String name, OBControl boxControl, int colour, boolean groupBox, float realign, float size, XPRZ_SectionController controller)
    {
    ...
    public static void showEquation(OBGroup equation,int from, int to, String audio, XPRZ_SectionController controller) throws Exception
    {
        controller.lockScreen();
    ...
    public static void hideEquation(OBGroup equation, XPRZ_SectionController controller)
    {
    ...
    public static void colourEquation(OBGroup equation, int from, int to, int colour, XPRZ_SectionController controller)
    {
        controller.lockScreen();
        for(int i=from; i <= to; i++)
        {
