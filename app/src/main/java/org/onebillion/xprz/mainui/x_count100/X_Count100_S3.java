 ...
 */
public class X_Count100_S3 extends XPRZ_SectionController
{
    ...
    public void prepare()
    {
        ...
        X_Count100_Additions.drawGrid(5,this.objectDict.get("workrect"),OBUtils.colorFromRGBString(eventAttributes.get("linecolour")), numColour, false, false, this);
