...
public class OC_VideoPlayback extends OC_Menu
{
...
//    private float tabTextSize, subheadtextSize, subsubheadtextSize, itemHeadTextSize, itemBodyTextSize;
//    private float videoHeadTextSize, videoBodyTextSize;
//    private float toggleTextSize, videoPreviewTextHeadingSize, videoPreviewSubTextSize;
//    private static Typeface plain, bold, italic, boldItalic;
//    private boolean scrollable;
//    float originalY;
    private float maximumX, minimumX;
//    private OBControl scrollGroup;
...
//    List<String>languages,languageNames;
    private OBControl highlightedIcon = null;
...
//    }
    ...
    {
        return videoPlayer != null && videoPlayer.frame().equals(boundsf());
    }
    ...
    private void setUpVideoPlayerForIndex (int idx, boolean play)
    {
        if (idx == 0 && !play)
...
//        }
    ...
    private void goToTarget (OBControl c)
    {
    ...
    private void highlightIcon (OBControl c)
    {
...
//        checkMessageNow();
    ...
    private void setHighlightedIcon (OBControl c)
    {
        highlightedIcon = c;
    }
}
