...
//        if (value)
//        {
//            colourObjectWith(button colourRGB:"255,50,50");
//
//        }
//        else
//        {
//            colourObjectWith(button colourRGB:"193,33,40");
//
//        }
//
//    }
...
//    {
//        lockScreen();
//        for (OBGroup control : numbers)
//        {
//            if (control.equals(number))
//            {
//                [control.objectDict.get("frame") setFillColor:
//            Color.yellowColor()];
//
//            }
//            else
...
//    }
//
//    public void checkButton (OBGroup button)
//    {
//        setStatus(STATUS_CHECKING);
//        playAudio(null);
//        playSfxAudio("separate_objects", false);
//        action_hiliteButton(button value:true);
//        List<> animations = new ArrayList<>();
//        lockScreen();
//        for (OBGroup group : filterControls("group.*"))
//        {
//            group.setAnchorPoint(new PointF(0.5f, 1f));
//            OBPath path = objectDict.get([group.attributes["id")
//            stringByReplacingOccurrencesOfString:
//            "group" withString:
//        "path"]];
//            if (path)
//            {
//                path.sizeToBox(bounds());
...
//        action_hiliteButton(button value:false);
//        waitForSecs(0.3f);
//        lockScreen();
//        for (int i = 1;
//             i <= filterControls("group.*").size();
//             i++)
//        {
...
//
//        unlockScreen();
//        OBUtils.runOnOtherThreadDelayed(1.2, new OBUtils.RunLambda()
//        {
...
//        int answer = ((OBControl) number.objectDict(int)"frame"])..attributes["number" ();
//        if (correct_answer == answer)
//        {
//            gotItRightBigTick(true);
//            waitForSecs(0.3f);
//            if (!performSel("finDemo"suffix:currentEvent()))
//            {
...
//
//        }
//        else if (statusWaitObjectClick())
//        {
//            Object number = findNumber(pt);
//            if (number)
//            {
//                OBUtils.runOnOtherThread(new OBUtils.RunLambda()
//                {
