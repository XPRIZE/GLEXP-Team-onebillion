 ...
 */
public class OC_Count100_S1i extends OC_SectionController
{
    ...
    public void prepare()
    {
        ...
        OC_Count100_Additions.drawGrid(maxrow,objectDict.get("workrect"),OBUtils.colorFromRGBString(eventAttributes.get("linecolour")),numcolour,false,this);
    ...
    private void checkTouch() throws Exception
    {
        ...
        for(int i = (currentrow-1)*10; i<currentrow*10; i++)
        {
            ...
            OC_Count100_Additions.playNumberAudio(i+1,true,this);
