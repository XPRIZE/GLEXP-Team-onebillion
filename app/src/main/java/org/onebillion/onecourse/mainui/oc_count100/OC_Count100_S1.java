 ...
 */
public class OC_Count100_S1 extends OC_SectionController
{
    ...
    public void fin()
    {
        ...
        {
            waitForSecs(0.3f);
            goToCard(OC_Count100_S1i.class,"event1");
        }
        catch (Exception e)
        {
    ...
    public void demoFin1c() throws Exception
    {
        ...
        OC_Generic.setFirstPoint(path1, new PointF(-1*bee.width(), path1.firstPoint().y), this);
