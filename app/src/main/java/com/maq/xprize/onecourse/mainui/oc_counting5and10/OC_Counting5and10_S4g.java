 ...
 */
public class OC_Counting5and10_S4g extends OC_Generic_SelectCorrectObject
{
    OBGroup alignmentGroup;
    int correctAnswer;


    public OC_Counting5and10_S4g ()
    {
        super();
    }
    ...
    public void demo4g() throws Exception
    {
        ...
        PointF destination = OC_Generic.copyPoint(alignmentGroup.position());
        ...
        //
        destination = OC_Generic.copyPoint(box.getWorldPosition());
        OC_Generic.pointer_moveToObject(label, -15, 0.6f, EnumSet.of(OC_Generic.Anchor.ANCHOR_MIDDLE), true, this);
...
//            [OBAudioManager.sharedAudioManager() prepare:audioScenes"sfx".()"bounce".()0.() onChannel:String.format("bounce_%d", i)];
    ...
    public void checkTarget(OBControl targ)
    {
        ...
        {
            System.out.println("OC_Counting5and10_S4g.exception caught: " + e.toString());
            e.printStackTrace();
        }
    }
}
