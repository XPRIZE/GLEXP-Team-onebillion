package com.maq.xprize.onecourse.hindi.mainui.oc_meetletter;
 ...
 */
public class OC_Mgp extends OC_SectionController
{
    ...
    public void prepare()
    {
        ...
        for(String loc : locNames)
        {
            ...
            for(String num : locNums.split(","))
            {
                ...
                locs.add(OC_Generic.copyPoint(con.position()));
            }
    ...
    public void setSingleTarget(OBPhoneme letter)
    {
        ...
        PointF loc = OC_Generic.copyPoint(textBox.position());
    ...
    public void prepareTargets(List<OBPhoneme> letters, List<PointF> locs, Typeface font, float fontSize)
    {
        for(int i=0; i<letters.size(); i++)
        {
            ...
            letterLabel.hide();
            letterLabel.setProperty("drop_loc",OC_Generic.copyPoint(locs.get(i)));
