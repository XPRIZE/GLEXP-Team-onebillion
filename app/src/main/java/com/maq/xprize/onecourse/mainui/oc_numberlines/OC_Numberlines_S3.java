 ...
 */
public class OC_Numberlines_S3 extends OC_SectionController
{
    PointF frogPosition;
    ...
    public void prepare()
    {
        ...
        OC_Numberlines_Additions.drawNumberLine(objectDict.get("numberline"),5,1,
    ...
    private void checkNum(OBLabel cont) throws Exception
    {
        ...
        if((int)cont.settings.get("num_value")  == targetNum)
        {
            ...
            if(currentEvent() != events.get(events.size()-1))
                OC_Numberlines_Additions.resetNumberLine(true, OBUtils.getBooleanValue(eventAttributes.get("reset")),this);
    ...
    public void demo3p() throws Exception
    {
        ...
        thePointer.hide();
        waitForSecs(1f);
        OC_Numberlines_Additions.resetNumberLine(true,true,this);
        waitForSecs(0.5f);
        nextScene();
    }
    ...
    public void demoFin3r() throws Exception
    {
        playAudioScene("FINAL",0,true);
        waitForSecs(0.3f);
        OC_Numberlines_Additions.animateCurve(4,false,0.65f,true,false,this);
        waitForSecs(0.2f);
        OC_Numberlines_Additions.animateCurve(3,false,0.65f,true,false,this);
        waitForSecs(1f);
    }
    ...
    public void demoFin3t() throws Exception
    {
        ...
        OC_Numberlines_Additions.animateCurve(3,false,0.65f,true,false,this);
        waitForSecs(0.2f);
        OC_Numberlines_Additions.animateCurve(2,false,0.65f,true,false,this);
        waitForSecs(1f);
    }
}
