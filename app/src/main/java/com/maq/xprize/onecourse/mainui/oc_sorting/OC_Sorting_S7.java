package com.maq.xprize.onecourse.mainui.oc_sorting;
 ...
 */
public class OC_Sorting_S7 extends OC_SectionController
{
    ...
    void cardStuffAdjustTable(boolean adjustTable)
    {
        ...
        for (int i = 0;i < 6;i++)
        {
            ...
            crds.add(c);
            c.setProperty("tag",i);
            c.setRasterScale(applyGraphicScale(c.scale()));
    ...
    public void demo7a() throws Exception
    {
        ...
        waitForSecs(0.2f);
        movePointerForwards(applyGraphicScale(50),0.1f);
        waitForSecs(0.05f);
        movePointerForwards(applyGraphicScale(-50),0.1f);
        int onecard[] = {0};
