package com.maq.xprize.onecourse.hindi.mainui.oc_moreaddsubtract;
 ...
 */
public class OC_MoreAddSubtract_S6i extends OC_SectionController
{
    ...
    public void prepare()
    {
        ...
        PointF loc2 =  OC_Generic.copyPoint(objectDict.get("eqbox2").position());
    ...
    public void setSceneXX(String  scene)
    {
        ...
        OC_Numberlines_Additions.loadEquation(equation1,"equation_1",objectDict.get("eqbox1"),eventColour.get("equation"),false,0,0.9f,this);

        detachControl(objectDict.get("equation_2"));
        String equation2 = String.format( "%s – %s = %s", eqParts[2], eqParts[1], eqParts[0]);
        OC_Numberlines_Additions.loadEquation(equation2,"equation_2",objectDict.get("eqbox2"),eventColour.get("equation"),false,0,0.9f,this);

        OBLabel eqLabel = OC_Numberlines_Additions.getLabelForEquation(1,(OBGroup)objectDict.get("equation_1"));
        ...
        for(String num : eventAttributes.get("nums").split(","))
        {
            ...
            group.setProperty("start_loc",OC_Generic.copyPoint(group.position()));
