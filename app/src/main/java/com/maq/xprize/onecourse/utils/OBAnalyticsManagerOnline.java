...
import com.maq.xprize.onecourse.mainui.oc_playzone.OC_PlayZoneAsset;
...
public class OBAnalyticsManagerOnline extends OBAnalyticsManager
{
     ...
     * parse-dashboard --appId "com.maq.xprize.onecourse.kenya" --masterKey "4asterix" --serverURL "http://onecourse-kenya.herokuapp.com/parse" --appName "onecourse-kenya"
     *
     */
    ...
    protected void startupAnalytics (Activity activity)
    {
        ...
        Parse.initialize(new Parse.Configuration.Builder(activity)
                .applicationId("com.maq.xprize.onecourse.kenya")
