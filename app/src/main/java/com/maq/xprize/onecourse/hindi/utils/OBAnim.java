...
/**
 * OBAnim
 * Creates Animations for OBControl. Types of animations: opacity, scale, rotation, position, colour, movement along path, properties.
 * These Animations are run by OBAnimationGroup
 * @see com.maq.xprize.onecourse.hindi.controls.OBControl
 * @see OBAnimationGroup
