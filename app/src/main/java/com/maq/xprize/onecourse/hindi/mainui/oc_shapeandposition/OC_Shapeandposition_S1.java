package com.maq.xprize.onecourse.hindi.mainui.oc_shapeandposition;
 ...
 */
public class OC_Shapeandposition_S1 extends OC_SectionController
{
    public void prepare()
    {
        super.prepare();
    ...
    public void fin()
    {
        goToCard(OC_Shapeandposition_S1B.class,(String)params);
    }
