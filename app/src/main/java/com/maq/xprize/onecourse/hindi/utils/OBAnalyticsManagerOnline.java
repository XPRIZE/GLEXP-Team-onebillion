...
public class OBAnalyticsManagerOnline extends OBAnalyticsManager
{
     ...
     * parse-dashboard --appId "com.maq.xprize.onecourse.hindi.kenya" --masterKey "4asterix" --serverURL "http://onecourse-kenya.herokuapp.com/parse" --appName "onecourse-kenya"
     *
     */
    ...
    protected void startupAnalytics (Activity activity)
    {
        ...
        Parse.initialize(new Parse.Configuration.Builder(activity)
                .applicationId("com.maq.xprize.onecourse.hindi.kenya")
