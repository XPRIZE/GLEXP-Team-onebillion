 ...
 */
public class OC_Counting7To10_S5 extends OC_Generic_Event
{
    ...
    public void demo5a () throws Exception
    {
        ...
        OC_Generic.pointer_moveToObject(label, 0, 0.6f, EnumSet.of(OC_Generic.Anchor.ANCHOR_BOTTOM), true, this);
        waitAudio();
        waitForSecs(0.3);
        //
    ...
    public void checkTrace ()
    {
        ...
        {
            System.out.println("OC_Counting7To10_S5.exception caught: " + e.toString());
            e.printStackTrace();
        }
    }
