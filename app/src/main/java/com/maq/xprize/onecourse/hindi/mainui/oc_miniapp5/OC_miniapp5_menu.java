package com.maq.xprize.onecourse.hindi.mainui.oc_miniapp5;
...
import com.maq.xprize.onecourse.hindi.utils.OC_FatReceiver;
 ...
 */
public class OC_miniapp5_menu extends OC_Menu implements OC_FatReceiver
{
    OBEmitter emitter;
    ...
    public void receiveCommand(Map<String,Object> params)
    {
        ...
        if((lastCommand == OC_FatController.OFC_SUCCEEDED || lastCommand == OC_FatController.OFC_FINISHED_LOW_SCORE) && bigIcon != null)
        {
    ...
    public void start()
    {
        OBUtils.runOnOtherThread(new OBUtils.RunLambda()
        {
            public void run() throws Exception
            {
                ...
                else if(lastCommand == OC_FatController.OFC_SUCCEEDED || lastCommand == OC_FatController.OFC_FINISHED_LOW_SCORE)
                {
                    lastCommand = -1;
                    if(prepareNextEvent())
                    {
